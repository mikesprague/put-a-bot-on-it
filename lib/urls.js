...
export const tenorApiSearch = ({ apiKey, searchTerm, limit = 50, offset = 0 }) =>
  `https://g.tenor.com/v1/search?key=${apiKey}&q=${searchTerm}&limit=${limit}&pos=${offset}&contentfilter=off&locale=en_US&media_filter=minimal`;

export const tenorApiShare = ({ apiKey, searchTerm, gifId }) => `https://g.tenor.com/v1/registershare?key=${apiKey}&id=${gifId}&q=${searchTerm}&locale=en_US`;
