module.exports = {
  ...
  boredApi: () => 'https://www.boredapi.com/api/activity?participants=1',
  ...
  nationalDayApi: () => 'https://api.m5ls5e.com/api/national-day-calendar/',
  ...
  thisForThatApi: () => 'https://itsthisforthat.com/api.php?json',

  trumpApi: () => 'https://www.tronalddump.io/random/quote',

  vaccineSpotterApi: (stateCode = 'NY') =>
    `https://www.vaccinespotter.org/api/v0/states/${stateCode}.json`,

  wordleSolutionApi: () => 'https://api.m5ls5e.com/api/get-wordle-solution/',
