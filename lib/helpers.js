...
exports.getRandomNum = (maxValue) => Number(rando(maxValue - 1));

exports.getRandomColor = (options = {}) =>
  options.length ? randomColor(options) : randomColor();

exports.normalizeMsgContent = (msg) => msg.content.toLowerCase().trim();
...
exports.sendContent = async (interaction, content, reaction = null) => {
  try {
...
exports.sendEmbed = async (interaction, content, reaction = null) => {
  try {
